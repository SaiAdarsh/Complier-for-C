...
B	
 :TEXT RELOP TEXT 		{
	...
	|  NOT B		{
     ...
     ;
S: identifier ASSIGNOP expression QUOT		{
	...
	| S S
     ;
fun_invo 
	:  TEXT LPAREN identifier_list RPAREN QUOT{
				gen(CALL,VOID,VOID,$1);
				gen(RETURN,VOID,VOID,VOID);}
	| type TEXT LPAREN identifier_list RPAREN QUOT{
				gen(CALL,VOID,VOID,$2);
				gen(RETURN,VOID,VOID,VOID);}
