...
%token TIMES PLUS LPAREN RPAREN QUOT EQUALS COMMA COLON PROGRAM BEGINT ENDT INPUT OUTPUT WHILE IF ELSE MINUS DIVIDE THEN FLOAT DOUBLE OCURLY CCURLY  AND OR NOT ASSIGNOP LT GT EQ LTE NE GTE LOOP UNTIL ENDTIF ENDTLOOP
